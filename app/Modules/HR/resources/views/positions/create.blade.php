<x-app-layout>
    ...
    <div class="max-w-2xl bg-paper-white border border-border-gray/80 rounded-card p-6 shadow-subtle">
        <div class="border-b border-border-gray/60 pb-4 mb-6">
            <h3 class="text-heading-sm font-semibold text-ink-black">Informasi Posisi Jabatan</h3>
            <p class="text-caption text-slate-gray mt-0.5">Tentukan nama jabatan dan unit departemen penempatannya.</p>
        </div>
        ...
        <form method="POST" action="{{ route('hr.positions.store') }}" class="space-y-5">
            ...
            <x-input
                ...
                placeholder="Contoh: Senior Fullstack Developer, Finance Staff"
                required
                :value="old('title') ?? ''"
            />
